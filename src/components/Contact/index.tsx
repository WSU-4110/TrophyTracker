const Contact = () => {
  return (
    <section id="contact" className="relative py-20 md:py-[120px]">
      ...
      <div className="dark:bg-dark-700 absolute left-0 top-0 -z-[1] h-1/2 w-full bg-[#E9F9FF] lg:h-[45%] xl:h-1/2"></div>
          ...
          <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
            <div className="ud-contact-content-wrapper">
              <div className="ud-contact-title mb-12 lg:mb-[150px]">
                ...
                <h2 className="text-dark max-w-[260px] text-[35px] font-semibold leading-[1.14] dark:text-white">
