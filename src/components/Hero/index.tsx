            ...
            <div className="w-full px-4">
              ...
              >
                ...
                <p className="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]">
                  The Ultimate Platform for Tracking Your Achievements
                </p>
                <ul className="mb-10 flex flex-wrap items-center justify-center gap-5">
                  <li> 
                    <Link
                      href="/auth/signin"
                      className="text-dark shadow-1 hover:bg-gray-2 inline-flex items-center justify-center rounded-md bg-white px-7 py-[14px] text-center text-base font-medium transition duration-300 ease-in-out"
                    >
                      Get Started
                    </Link>
                  </li>
                  <li>
                    <Link
                      href="https://github.com/WSU-4110/TrophyTracker"
                      target="_blank"
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <path d="M19 0h-14c-2.762 0-5 2.239-5 5v14c0 2.761 2.238 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-8 17.882l-6-.838v-4.044h6v4.882zm0-5.882h-6v-5.044l6-.838v5.882zm8 7l-7-.978v-5.022h7v6zm0-7h-7v-6.022l7-.978v7z"/>
                        </g>
                      </svg>
                    </a>
