        ...
        <div className="space-y-8">
          <div className="rounded-xl bg-white p-8 shadow-xl transition-shadow duration-300 hover:shadow-2xl dark:bg-gray-700">
            ...
            <p className="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
              Thank you for choosing to be part of our community at [Your
            ...
            <p className="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
              When you visit our website [Your Website URL] (the
              &quot;Website&quot;), and more generally, use any of our services
              (the &quot;Services&quot;, which include the Website), we
          ...
          <div className="rounded-xl bg-white p-8 shadow-xl transition-shadow duration-300 hover:shadow-2xl dark:bg-gray-700">
            ...
            <p className="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
              We collect personal data when you use our website, including
              information you provide by filling out forms, details of your
              visits, and the resources that you access. This information
              includes your IP address, web browser details, time zone, and
              operating system, as well as information concerning your browsing
              behavior on our website, such as the pages you visit and the
              actions you take.
            </p>
          </div>
          <div className="rounded-xl bg-white p-8 shadow-xl transition-shadow duration-300 hover:shadow-2xl dark:bg-gray-700">
            ...
            <p className="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
              ...
              company and our users. We also use this information to offer you
              tailored content – like giving you more relevant search results
              and ads. Additionally, we use this information to:
              <ul className="list-disc pl-5">
                <li>
                  Communicate with you, including for customer service, to
          ...
          <div className="rounded-xl bg-white p-8 shadow-xl transition-shadow duration-300 hover:shadow-2xl dark:bg-gray-700">
            ...
            <p className="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
              ...
              personal data. These include the right to access, correct, update,
              or request deletion of your personal data. You can also object to
              processing of your data, ask us to restrict processing of your
              data, or request portability of your data. Just contact us at the
              details provided above to exercise these rights.
            </p>
          </div>
          <div className="rounded-xl bg-white p-8 shadow-xl transition-shadow duration-300 hover:shadow-2xl dark:bg-gray-700">
            <h2 className="mb-4 text-3xl font-bold text-gray-800 dark:text-white">
          ...
          <div className="rounded-xl bg-white p-8 shadow-xl transition-shadow duration-300 hover:shadow-2xl dark:bg-gray-700">
            ...
            <p className="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
              ...
              <ul className="list-disc pl-5">
                ...
                <li>Mail: [Street, City, State, Postal Code]</li>
              </ul>
            </p>
          </div>
        </div>
